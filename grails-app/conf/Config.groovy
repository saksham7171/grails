...
grails.config.locations = ["file:/home/saksham/extern_config.groovy"]
...
log4j.main = {
    ...
    appenders {
        ...
        file name: 'file', file: '/home/saksham/glogs.log', layout: pattern(conversionPattern: '%c{2} %m%n')
    }
    info "grails.app.controllers.com.ttnd.linksharing.UnitController"
    info "grails.app"
