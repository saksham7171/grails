        ...
        <div class="panel panel-default">
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <g:link controller="topic" action="show" style="float:right"
                                        params="[topicId: resource.topicId, visibility: resource.topic.visibility.toString()]">${resource.topic}</g:link>
                            </div>
                        </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-2 ">
                        <ins><ls:canDeleteResource user="${session.user}"
                                                   id="${resource?.id}"/></ins>
                    </div>
                </div>
            </div>
